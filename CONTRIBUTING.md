...
If you believe you have found an issue with the code please do not hesitate to file an issue in [Github](https://github.com/dronrider/krakend-otel/issues). When
...
2. [Fork the project](https://github.com/dronrider/krakend-otel/fork)
...
using the following command:
    ...
    git remote add upstream https://github.com/dronrider/krakend-otel.git
